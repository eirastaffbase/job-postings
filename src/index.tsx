...
import { JobPostingsProps, JobPostings } from "./job-postings";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/job-postings.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <job-postings message="world!"></job-postings>
   */
  return class JobPostingsBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): JobPostingsProps {
      const attrs = this.parseAttributes<JobPostingsProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<JobPostings {...this.props} />);
    }
